...
public abstract class AbstractTestXxHash64
{
    ...
    @Test
    public void testHash64EmptyWithSeed()
    {
    ...
    @Test
    public void testHash64SanityBuffer()
    {
    ...
    @Test
    public void testHash64WithOffset()
    {
    ...
    @Test
    public void testStreamingMultipleUpdates()
    {
    ...
    @Test
    public void testStreamingWithSeed()
    {
    ...
    @Test
    public void testStreamingReset()
    {
    ...
    @Test
    public void testStreamingResetWithSeed()
    {
    ...
    @Test
    public void testStreamingDigestDoesNotModifyState()
    {
        byte[] data = "Test data".getBytes(StandardCharsets.UTF_8);
    ...
    @Test
    public void testStreamingEmpty()
    {
        try (XxHash64Hasher hasher = createHasher()) {
    ...
    @Test
    public void testStreamingChunkedMatchesOneShot()
    {
    ...
    @Test
    public void testStreamingFluentApi()
    {
        byte[] part1 = "Hello".getBytes(StandardCharsets.UTF_8);
    ...
    @Test
    public void testUpdateLELengthPrefixed()
    {
        byte[] data = "Hello, World!".getBytes(StandardCharsets.UTF_8);
    ...
    @Test
    public void testHashLongWithSeed()
    {
    ...
    @Test
    public void testHashLongKnownValues()
    {
    ...
    @Test
    public void testHashLongMatchesStreaming()
    {
