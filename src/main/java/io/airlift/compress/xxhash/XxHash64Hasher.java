 ...
 * </pre>
 * <p>
 * Ported from upstream aircompressor v3 (PR #316/#318); only the pure-Java
 * implementation is provided, so the static methods always use it.
 */
public interface XxHash64Hasher
